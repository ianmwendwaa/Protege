...
public class UserConfirmation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.done.setOnClickListener(v -> {
            ...
            AbstractMutableList<Password> passRequest = (AbstractMutableList<Password>) db.fetchPasswordRequest();
            if(myPassword.equals(passRequest)){
                startActivity(new Intent(UserConfirmation.this, AddNoteActivity.class));
            }else{
                CodeBase.showToast(UserConfirmation.this, "You have entered the wrong password!", R.drawable.ic_info);
            }
        });
